...
SERVICE_NAME = os.getenv("SERVICE_NAME", "user-management-service")
DATABASE_URL = os.getenv(
    "DATABASE_URL",
    "postgresql+psycopg2://smartretailx:smartretailx@localhost:5432/user_service",
)
...
SQS_QUEUE_URL_USER_EVENTS = os.getenv("SQS_QUEUE_URL_USER_EVENTS", "")
