...
TEST_DB_PATH = SERVICE_ROOT / "tests" / "test_inventory_service.db"
...
def _mock_event_publisher(monkeypatch):
    """Safety net so no test ever opens a real RabbitMQ connection, even
    indirectly (e.g. a consumer handler publishing a follow-up event)."""
